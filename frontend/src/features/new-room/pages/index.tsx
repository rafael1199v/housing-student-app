	...
	return (
		<div className="mx-auto w-full max-w-full space-y-6">
			...
			<div className="flex flex-row">
				{/* TODO: Añadir pasos del Wizard, ocultar o comprimir en modo mobile */}
				<h1 className="text-2xl font-semibold text-slate-900 not-md:hidden">
					{t("newRoom.title")}
				</h1>
				<div className="flex flex-col">
					...
					>
						...
						<div className="flex items-center justify-end gap-3 pb-8">
							<button
								type="button"
								onClick={() => navigate("/")} // Añadir navegación a la pestaña siguiente
