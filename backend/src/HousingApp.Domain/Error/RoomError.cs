...
public static class RoomError
{
    ...
    public static readonly Error HouseholderNotFound =
        new("room.householder.not.found", "No se encontró el propietario del alojamiento");
    ...
    public static readonly Error InvalidDescription =
        new("room.invalid.description", "La descripción del alojamiento es inválida");
    ...
    public static readonly Error InvalidRoomStatus =
        new("room.invalid.status", "El estado del alojamiento es inválido");
    ...
    {
        return new Error("room.filter.not.exist", $"El filtro '{filter}' no existe");
    }

    public static Error InvalidFilterValue(string filter)
    {
        return new Error("room.filter.invalid.value", $"El valor del filtro '{filter}' no es válido");
    }

    public static Error MaxImagesExceeded(int maxImages)
    {
        return new Error("room.images.max.exceeded", $"La cantidad máxima de imágenes es {maxImages}");
    }
}
