namespace HousingApp.Application.Utils;

public static class EmailTemplateUtil
{
    public static string BuildConfirmationTemplateContent(string firstName, string link)
    {
        return $"""
                <!DOCTYPE html>
                <html lang="en">
                          ...
                          <tr>
                            <td style="padding:32px 32px 24px;">
                              ...
                              <p style="margin:0 0 24px;font-size:14px;color:#6b7280;line-height:1.7;">
                                Welcome to Itersapiens, {firstName}! We just need to verify your email address to activate your account.
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="center" style="padding-bottom:24px;">
                                    <a href="{link}"
                                       style="display:inline-block;background-color:#1a1a2e;color:#ffffff;padding:14px 32px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600;">
                                      Confirm my email
                                    </a>
                                  </td>
                                </tr>
                          ...
                          <tr>
                            <td style="background-color:#f9fafb;padding:16px 32px;text-align:center;border-top:1px solid #f3f4f6;">
                              <p style="margin:0;font-size:11px;color:#9ca3af;">
                                © 2026 Itersapiens · All rights reserved
                              </p>
                            </td>
                          </tr>
